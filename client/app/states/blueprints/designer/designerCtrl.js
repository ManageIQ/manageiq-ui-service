angular.module('app.states').controller('designerCtrl', ['$scope', '$timeout', 'BlueprintsState', '$state',
    function($scope, $timeout, BlueprintsState, $state) {
        ...
        if(blueprintId) {
            if(blueprintId !== '-1') {
                //console.log("Attempting to retrieve blueprint");
                ...
                if (blueprint) {
                    ...
                    //console.log("found existing blueprint: " + blueprint.name +", " + blueprint.id);
                } else {
                    //console.log("Error retrieving blueprint for " + blueprintId);
                }
            } else {
                //new blueprint, saveBlueprint will auto-increment blueprint id
                //console.log("Attempting to save new blueprint");
        ...
        $scope.$on('BlueprintChanged', function (evt, args) {
            //console.log("BlueprintChanged received");
            //console.log("args.chartDataModel = " + JSON.stringify(args.chartDataModel));
            //console.log("blueprint.chartDataModel = " + JSON.stringify(blueprint.chartDataModel));
        ...
        $scope.saveBlueprint = function(){
            //console.log("Attempting to Save Blueprint: " + blueprint.name +", " + blueprint.id)
            ...
            //console.log("Blueprint Saved ("+blueprint.id+")");
        }
        ...
        $scope.tabs = [
            { title:'Compute', subtabs: [
                {title:'VMWare', items: [{title: 'Amazon Operations', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'},
                ...
                {title:'RHEV', items:   [{title: 'OpenShift Production', image: 'assets/images/miq-icons/OpenShift-prod.jpg', nodeBackgroundColor: '#f7bd7f'},
                ...
                {title:'AWS', items:    [{title: 'AWS Cat Item 1', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'},
                    {title: 'AWS Cat Item 2', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'}]}
            ]
            },
            { title:'Storage', subtabs: [
                {title:'StorageA', items: [{title: 'StorageA Cat Item 1', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'},
                    {title: 'StorageA Cat Item 2', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'}] },
                {title:'StorageB', items: [{title: 'StorageB Cat Item 1', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'},
                    {title: 'StorageB Cat Item 2', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'}]},
                {title:'StorageC', items: [{title: 'StorageC Cat Item 1', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'},
                    {title: 'StorageC Cat Item 2', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'}]}
            ]
            },
            { title:'Network', subtabs:[
                {title:'NetworkA', items: [{title: 'NetworkA Cat Item 1', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'},
                    {title: 'NetworkA Cat Item 2', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'}]},
                {title:'NetworkB', items: [{title: 'NetworkB Cat Item 1', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'},
                    {title: 'NetworkB Cat Item 2', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'}]},
                {title:'NetworkC', items: [{title: 'NetworkC Cat Item 1', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'},
            ...
            { title:'Applications', subtabs:[
                {title:'AppsA', items: [{title: 'AppsA Cat Item 1', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'},
                    {title: 'AppsA Cat Item 2', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'}]},
                {title:'AppsB', items: [{title: 'AppsB Cat Item 1', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'},
                    {title: 'AppsB Cat Item 2', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'}]},
                {title:'AppsC', items: [{title: 'AppsC Cat Item 1', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'},
                    {title: 'AppsC Cat Item 2', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'}]}
            ]
            },
            { title:'Other', subtabs:[
                {title:'OtherA', items: [{title: 'OtherA Cat Item 1', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'},
                    {title: 'OtherA Cat Item 2', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'}]},
                {title:'OtherB', items: [{title: 'OtherB Cat Item 1', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'},
                    {title: 'OtherB Cat Item 2', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'}]},
                {title:'OtherC', items: [{title: 'OtherC Cat Item 1', image: 'assets/images/miq-icons/catalogItem.png', nodeBackgroundColor: '#f9d67a'},
