angular.module('app.states')
    .controller('blueprintEditorCtrl', ['$scope', '$timeout', 'BlueprintsState', 'DesignerState', 'BlueprintDetailsModal',
      'SaveBlueprintModal', '$rootScope', '$state', 'CollectionsApi', 'Notifications', 'sprintf',
      function($scope, $timeout, BlueprintsState, DesignerState, BlueprintDetailsModal, SaveBlueprintModal, $rootScope, $state, // jshint ignore:line
               CollectionsApi, Notifications, sprintf) {
