...
describe('Service: VmsService', () => {
  ...
  it('should allow for a vm to be retrieved', (done) => {
  ...
  it('should be able to get snapshots', (done) => {
    ...
    service.getSnapshots('12345').then((data) => {
      done()
