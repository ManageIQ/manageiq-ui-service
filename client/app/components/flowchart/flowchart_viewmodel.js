...
(function () {
	...
	flowchart.computeConnectorY = function (connectorIndex) {
		return flowchart.nodeNameHeight + (connectorIndex * flowchart.connectorHeight) + (flowchart.defaultNodeHeight - flowchart.nodeNameHeight);
	}
	...
	flowchart.ConnectorViewModel = function (connectorDataModel, x, y, parentNode) {
		...
		this.data = connectorDataModel;491
