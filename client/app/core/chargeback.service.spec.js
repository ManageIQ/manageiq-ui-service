...
describe('Chargeback', () => {
  ...
  describe('adjustRelativeCost', () => {
    ...
    it('assigns chargeback_relative_cost correctly', () => {
  ...
  describe('currentReport', () => {
    ...
    it('picks only the latest start_date', () => {
      let report = Chargeback.currentReport(item)
